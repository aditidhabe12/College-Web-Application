  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="https://educloud.app/school/image?path=kbjit/schoolicon/6a4f8fc9-208a-4e8b-bdbb-d3a1ae6b8c14~~schoolLogo" class="img-fluid">
          </div>
           <div class="col">
              <div class="main-heading text-center mt-5">Maharshi Karve Stree Shikshan Samstha’s</div>
     <p class="sub-heading text-center">  K.B.Joshi Institute of Information Technology, Pune</p>
      <div class="address text-center">Rama Purushottam Vidya Sankul, 5th Floor,
Karvenagar, Pune – 411 052 , Maharashtra, India.
</div>
         <p class="email text-center"> Email: kbjiitbca@maharshikarvebcapune.org , Tel. No.: +91-8767954498
Fax No.: (020)25477599
 </p>
          </div>
          <div class="col-sm-12">
