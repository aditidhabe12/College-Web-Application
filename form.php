...
<div class="row">
  ...
  <div class="col-sm-8" style="border: 2px solid grey;padding:5px;  margin:10px;text-align: center;">
   ...
   <div class="col-sm-4">
     ...
     <select name="course" class="form-control" required>
      <option value="">Select Course</option>
        <option value="Basic Computer">BCA</option>
        <option value="Mathematics">Bsc</option>
        <option value="PHP Programming">MCA</option>
        <option value="PHP Programming">Msc</option>
     </select>
    </div>
    </div>
    </div>
...
<script>
 ...
 <div id="msg-price"> </div>
    ...
    <div class="col-sm-8">
      <div><div id="msg-price"> </div></div>
      
      <div style="border: 2px solid grey;padding:10px; text-align: center;border-radius: 25px;">
